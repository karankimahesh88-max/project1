...
# Accent color used for all buttons — change this one line to re-theme the app.
ACCENT_COLOR = "#4f46e5"       # indigo
ACCENT_COLOR_HOVER = "#4338ca"  # slightly darker indigo for hover


def apply_custom_styles():
    """
    Fixes buttons (e.g. 'Add investment', 'Log in', the 🗑️ delete icons)
    that default to a black background with black text/icons, making them
    invisible. Forces a clear accent color with white text everywhere.
    """
    st.markdown(
        f"""
        <style>
        ...
        div.stDownloadButton > button:hover {{
            ...
            border-color: {ACCENT_COLOR_HOVER} !important;
            color: #ffffff !important;
        }}
